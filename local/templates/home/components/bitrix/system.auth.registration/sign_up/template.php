...
<table class="data-table bx-registration-table">
	<div class="row form-group">
		<div class="col-md-12 mb-3 mb-md-0">
			<label class="font-weight-bold" for="user_name"><?=GetMessage("AUTH_REGISTER")?></label>
		</div>
	<tbody>
	...
	<label class="font-weight-bold" for="user_confirm_password"><span class="starrequired">*</span><?=GetMessage("AUTH_CONFIRM")?></label>
			...
			<input type="password" name="USER_CONFIRM_PASSWORD" maxlength="255" value="<?=$arResult["USER_CONFIRM_PASSWORD"]?>" class="bx-auth-input" autocomplete="off"/>
		</div>
	...
	<?if($arResult["EMAIL_REGISTRATION"]):?>
		<div class="row form-group">
			<div class="col-md-12 mb-3 mb-md-0">
		<label class="font-weight-bold" for="user_phone_number"><?if($arResult["PHONE_REQUIRED"]):?><span class="starrequired">*</span><?endif?><?=GetMessage("main_register_phone_number")?></label>
				</div>
	...
	<div class="row form-group">
		<div class="col-md-12 mb-3 mb-md-0">
	<label class="font-weight-bold" for="UF_SIGN_TYPE"><?=GetMessage("USER_TYPE")?></label>
	</div>
		<div class="col-md-12 mb-3 mb-md-0">
			<input type="radio" name="UF_SIGN_TYPE" value="Selling" />
			<label for="Selling"><?=GetMessage("USER_SELL")?></label>

			<input type="radio" name="UF_SIGN_TYPE" value="Buying" />
			<label for="Buying"><?=GetMessage("USER_BUY")?></label>
		</div>
	</div>
